...
- `管理 -> 系统设置`：决定公开站点地址、品牌、注册登录、邮件、跨域、任务调度、回收站、历史版本、WOPI 打开方式、WebDAV 开关和审计日志
...
| 改公开站点地址、站点标题、Logo、favicon、公开注册、Cookie 规则、Token 有效期、任务调度、回收站、版本历史、默认配额、WOPI 打开方式、WebDAV 开关或审计日志 | [系统设置](/config/runtime) |
