...
export const USER_TOPBAR_HEIGHT_CLASS = "h-14";
export const USER_TOPBAR_OFFSET_CLASS = "inset-y-14";

export const ADMIN_TOPBAR_HEIGHT_CLASS = "h-14";
export const ADMIN_TOPBAR_OFFSET_CLASS = "inset-y-14";
